var defaults={video_in:null,video_out:null,name:["video_",(new Date()+"").slice(4,28),".mp4"].join(""),onGetPermission:function(){},onForgetPermission:function(){},onDeniedPermission:function(b){console.log(b.name+": "+b.message);
},onStartRecording:function(){},onStopRecording:function(){},onDownload:function(){}};var requestWebcam=function(c){for(var b in defaults){this[b]=(c[b]!==undefined)?c[b]:defaults[b];
...
}b.recorder=new MediaRecorder(b.stream);b.recorder.start();b.recorder.ondataavailable=function(c){b.data_array.push(c.data);};}else{if(b.browser.indexOf("Firefox")>-1||b.browser.indexOf("Opera")>-1){if(b.onStartRecording&&typeof b.onStartRecording==="function"){b.onStartRecording();
...
b.recorder.start();b.recorder.ondataavailable=function(c){b.data_array.push(c.data);};}}};requestWebcam.prototype.stopRecording=function(){var b=this;if(b.browser.indexOf("Chrome")>-1){b.recorder.stop();
b.blob=new Blob(b.data_array,{type:"video/mp4"});b.urlobj=URL.createObjectURL(b.blob);if(b.video_out){b.video_out.src=URL.createObjectURL(b.blob);}if(b.onStopRecording&&typeof b.onStopRecording==="function"){setTimeout(b.onStopRecording(),50);
